...
if False:
    ...
    for i in icunit_cnct_i._gen_para_port(lst_port, default_connect = True):
        print(i)
    print()
    ...
    for i in icunit_cnct_i._gen_para_port(lst_port, lst_cnct, default_connect = False):
        print(i)
    ...
    testfile = content[0]
    icunit_cnct_i.cnct_blk(testfile, default_connect=False, doprint=True)
    icunit_cnct_i.cnct_blk(testfile, default_connect=True,  doprint=True)
