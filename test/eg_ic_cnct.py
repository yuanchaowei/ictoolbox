...
if False:
    ...
    ic_cnct_i.cnct_blk("adder", "i_adder", testpath, "", default_connect=False, doprint=True)
    ic_cnct_i.cnct_blk("adder", "i_adder", testpath, "", default_connect=True,  doprint=True)

#ic_cnct_i.cnct_blks("template.json", "riscv_core.sv", debug=True)

ic_cnct_i.cnct_blks("/home/chaov/riscv/gen/riscv_core.json", "riscv_core.sv", debug=True)
